# Generated by Django 2.1.1 on 2018-10-17 17:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('country', models.ForeignKey(help_text='Country where state is located.', null=True, on_delete=django.db.models.deletion.SET_NULL, to='backend.Country')),
            ],
            options={
                'ordering': ['name'],
            },
        ...
        migrations.AddField(
            model_name='company',
            name='industry',
            field=models.ForeignKey(help_text='Primary source of revenue.', null=True, on_delete=django.db.models.deletion.SET_NULL, to='backend.Industry'),
        ),
        migrations.AddField(
            model_name='city',
            name='state',
